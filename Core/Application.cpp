	...
	: m_Specification(specification)
{
	...
	std::cout << "[INFO] glfw v" << GLFW_VERSION_MAJOR << '.' << GLFW_VERSION_MINOR << " Initialized Window (" << specification.WindowWidth << " x " << specification.WindowHeight << ")\n";
	...
	std::cout << "[INFO] glad v" << GLAD_VERSION_MAJOR(loadGLresult) << '.' << GLAD_VERSION_MINOR(loadGLresult) << " Initialized\n";
